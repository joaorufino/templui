...
type D struct {
	...
	//playground:import:github.com/joaorufino/templui/components/dropdown
	//playground:import:github.com/joaorufino/templui/components/icon
	//playground:import:github.com/joaorufino/templui/components/size
